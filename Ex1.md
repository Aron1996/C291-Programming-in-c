...
The [course repository](https://github.iu.edu/SOIC-C-Unix/Spring1-2017)
will be duplicated using the steps. 

* Change directories to a scratch area. Create a bare clone of the
  Spring1-2017 repository using:

```bash
git clone --bare git@github.iu.edu:SOIC-C-UNIX/Spring1-2017.git
```

Note: If you did not configure SSH yet, you can use the HTTP link to the repository instead (DON'T DO BOTH)
```bash
git clone --bare https://github.iu.edu/SOIC-C-UNIX/Spring1-2017.git
```

* Enter the Spring1-2017.git directory
...
* Clone your **C291-Spring1-2017** to your home directory.
```bash
git clone yourreponame
```
* cd into the C291-Spring1-2017 directory. Add an upstream remote to your repository. Be sure to use the correct repo link/name.

```bash
git remote add upstream git@github.iu.edu:SOIC-C-Unix/Spring1-2017.git
```
